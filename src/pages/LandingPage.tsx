...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <motion.h2 
              ...
              transition={{ duration: 0.5 }}
              viewport={{ once: true }}
              className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-blue-900 via-indigo-800 to-purple-900 bg-clip-text text-transparent mb-6"
            >
      ...
      <div className="py-32 bg-gradient-to-br from-blue-900 via-indigo-800 to-purple-900 relative overflow-hidden">
