...
const UnifiedMarketplace = () => {
  ...
  const [mainTab, setMainTab] = useState<'all' | 'exhibitions'>('all'); // التبويب الرئيسي: السوق الشامل أو المعارض
  ...
  const [showCategoryMenu, setShowCategoryMenu] = useState(false); // قائمة الفئات المنسدلة
    ...
    return (
      ...
      >
        ...
        <div className={`relative h-40 bg-gradient-to-br ${
          isSupplierOffer ? 'from-blue-400 to-purple-600' :
          isMerchantRequest ? 'from-green-400 to-emerald-600' :
          isShippingService ? 'from-orange-400 to-red-600' :
          isShippingRequest ? 'from-purple-400 to-pink-600' :
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-1/2 -right-1/2 w-96 h-96 bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"></div>
        <div className="absolute -bottom-1/2 -left-1/2 w-96 h-96 bg-purple-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse delay-2000"></div>
      </div>
            ...
            <div className="flex gap-3">
              <button
                ...
                className={`px-8 py-4 rounded-xl font-bold transition-all flex items-center gap-3 ${
                  mainTab === 'all'
                    ? 'bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white shadow-xl transform scale-105'
                    : 'bg-white text-gray-600 hover:bg-gray-50 border-2 border-gray-200 hover:shadow-md'
                }`}
              >
                <ShoppingCart className="w-6 h-6" />
                <div className="text-right">
                  <div className="text-lg">السوق الشامل</div>
              ...
              <button
                ...
                className={`px-8 py-4 rounded-xl font-bold transition-all flex items-center gap-3 ${
                  mainTab === 'exhibitions'
                    ? 'bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-600 text-white shadow-xl transform scale-105'
                    : 'bg-white text-gray-600 hover:bg-gray-50 border-2 border-gray-200 hover:shadow-md'
                }`}
              >
                <Store className="w-6 h-6" />
                <div className="text-right">
                  <div className="text-lg">معارض الموردين</div>
            ...
            {mainTab === 'all' && (
              <div className="relative category-menu-container">
                <button
                  ...
                  className="px-6 py-4 bg-white border-2 border-gray-200 rounded-xl hover:shadow-md transition-all flex items-center gap-3 font-medium text-gray-700"
                >
              ...
              <div className="flex-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-6 pr-12 py-4 text-lg border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white/90 backdrop-blur-sm transition-all"
                  />
                  {searchQuery && (
                    <button
              ...
              <div className="flex gap-3">
                <div className="min-w-[160px]">
                  ...
                  <select
                    ...
                    className="w-full py-4 px-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white transition-all"
                    title="ترتيب النتائج"
                  >
            ...
            <div className="flex flex-wrap gap-4 mb-8 justify-center">
              {(user.role === 'supplier' || !user.role) && (
                <motion.button
                  ...
                  className="flex items-center gap-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-3 rounded-xl font-medium hover:from-blue-600 hover:to-purple-700 transition-all shadow-lg"
                >
              ...
              {(user.role === 'merchant' || !user.role) && (
                <motion.button
                  ...
                  className="flex items-center gap-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white px-6 py-3 rounded-xl font-medium hover:from-green-600 hover:to-emerald-700 transition-all shadow-lg"
                >
                  <Plus className="w-5 h-5" />
                  إضافة طلب تاجر
                </motion.button>
          ...
          <div className="mb-8">
            ...
            {sortedData.length === 0 ? (
              <div className="text-center py-16">
                ...
                >
                  {activeTab === 'supplier_offers' ? <Store className="w-16 h-16 text-gray-400" /> :
                   activeTab === 'merchant_requests' ? <Clipboard className="w-16 h-16 text-gray-400" /> :
                   activeTab === 'shipping_services' ? <Truck className="w-16 h-16 text-gray-400" /> :
